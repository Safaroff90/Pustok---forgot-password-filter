...
namespace _Pustok.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> ForgotPassword(ForgotPasswordViewModel forgotPassword)
        {
            ...
            email.From.Add(MailboxAddress.Parse("cristobal.pouros43@ethereal.email"));
            email.To.Add(MailboxAddress.Parse("cristobal.pouros43@ethereal.email"));
            ...
            smtp.Authenticate("cristobal.pouros43@ethereal.email", "GKEVUKWv3EQFR5TeaN");
            smtp.Send(email);
